...
describe('WalletService', () => {
  ...
  describe('initiateFundWallet', () => {
    it('should successfully initiate wallet funding', async () => {
      ...
      paymentGatewayService.initiateFundWallet.mockResolvedValue(expectedResponse);

      const result = await service.initiateFundWallet(fundWalletDto, userId);

      expect(walletRepository.createWalletIfNotExists).toHaveBeenCalledWith(userId);
